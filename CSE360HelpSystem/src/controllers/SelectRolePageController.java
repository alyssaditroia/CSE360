...
/**
* <p> Title: SelectRolePageController class </p>
*
* <p> Description: A JavaFX controller that manages the functionality of the role selection page in this application.
* This class extends the PageController base class, allowing it to inherit common page-related behavior
* while introducing role selection-specific actions. It handles the display of role-specific buttons based on
* the current user's permissions and manages navigation to the appropriate role-specific homepages. </p>
*
* <p> The controller interacts with the Database class to retrieve user role information and uses the UserSession
* to manage the current user's data. It provides methods for redirecting to Admin, Instructor, and Student
* homepages, as well as navigation back to the login page. </p>
*
* @author Justin Faris
*
*/
public class SelectRolePageController extends PageController{
    ...
    /**
     * Sets the visibility of the role buttons so that only the button options for roles that the user has
     * privileges for are displayed
     */
