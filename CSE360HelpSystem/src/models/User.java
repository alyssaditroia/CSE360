...
public class User {
    ...
    public void setPassword(String password) { this.password = password.toCharArray(); }
    ...
    public String getPreferredName() { return preferredName.get(); }
    public void setPreferredName(String preferredName) { this.preferredName.set(preferredName); }
    
    public Boolean isAdmin() { return isAdmin.get(); }
    public void setAdmin(Boolean isAdmin) { this.isAdmin.set(isAdmin); }
    
    public Boolean isStudent() { return isStudent.get(); }
    public void setStudent(Boolean isStudent) { this.isStudent.set(isStudent); }
    
    public Boolean isInstructor() { return isInstructor.get(); }
    public void setInstructor(Boolean isInstructor) { this.isInstructor.set(isInstructor); }
    
    public String getOtp() { return Otp; }
    public void setOtp(String Otp) { this.Otp = Otp; }
    
    public Timestamp getOtpExpiration() { return OtpExpiration; }
    public void setOtpExpiration(Timestamp timestamp) { this.OtpExpiration = timestamp; }
}